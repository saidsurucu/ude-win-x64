...
public class IconLoaderPatch {
    public static void main(String[] args) throws Exception {
        ...
        b.insertAfter(
          ...
          + "   String __base = $1.substring(0, $1.length() - 4);"
          + "   java.net.URL __u = tr.com.havelsan.uyap.system.editor.common.Utils.class.getResource(__base + \"@2x.png\");"
          + "   if (__u != null) {"
          + "     javax.swing.ImageIcon __hi = new javax.swing.ImageIcon(__u);"
          + "     java.net.URL __u15 = tr.com.havelsan.uyap.system.editor.common.Utils.class.getResource(__base + \"@1.5x.png\");"
          + "     java.awt.Image __m;"
          + "     if (__u15 != null) {"
          + "       javax.swing.ImageIcon __mid = new javax.swing.ImageIcon(__u15);"
          + "       __m = new java.awt.image.BaseMultiResolutionImage("
          + "           new java.awt.Image[]{ $_.getImage(), __mid.getImage(), __hi.getImage() });"
          + "     } else {"
          + "       __m = new java.awt.image.BaseMultiResolutionImage("
