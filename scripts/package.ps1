...
function Invoke-Package {
  ...
  # SKIN (varsayilan ACIK): winlook agent (canli gecis + renk-modu picker). $APPDIR runtime'da app dizinine cozulur.
  if ($env:SKIN -ne '0' -and (Test-Path (Join-Path $InputDir 'winlook.jar'))) {
